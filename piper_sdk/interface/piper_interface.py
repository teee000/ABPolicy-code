...
class C_PiperInterface():
    ...
    class ArmEndPose():
        ...
        def get_end_pose(self):
            dic = self.end_pose.get_end_pose()
            dic['timestamp'] = self.time_stamp
            return dic
    ...
    class ArmJoint():
        ...
        def get_joints(self):
            dic = self.joint_state.get_joints()
            dic['timestamp'] = self.time_stamp
            return dic
    ...
    class ArmGripper():
        ...
        def get_gripper_pose(self):
            dic = self.gripper_state.get_gripper_pose()
            dic['timestamp'] = self.time_stamp
            return dic
    ...
    ## !!!!
    def GetArmEndPoseDic(self):
        with self.__arm_end_pose_mtx:
            return self.__arm_end_pose.get_end_pose()
    
    ## !!!!
    def GetArmJointsDic(self):
        with self.__arm_joint_msgs_mtx:
            return self.__arm_joint_msgs.get_joints()
    ...
    ## !!!!
    def GetArmGripperDic(self):
        with self.__arm_gripper_msgs_mtx:
            return self.__arm_gripper_msgs.get_gripper_pose()
